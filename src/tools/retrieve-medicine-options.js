...
export async function fetchMedicineOptions() {
    try {
        ...
        const options = [
            ...
            { value: 'INSISTOR_10', label: 'Insistor 10 mg/ml', formula: { dog: 0.04, cat: 0.03 } },
            ...
            { value: 'BUPAQ_0_3', label: 'Bupaq 0.3 mg/ml', formula: { dog: 0.05, cat: 0.05 } },
            { value: 'ONSIOR_20', label: 'Onsior 20 mg/ml', formula: { dog: 0.1, cat: null } },
            { value: 'RHEUMOCAM_5', label: 'Rheumocam 5 mg/ml', formula: { dog: 0.04, cat: 0.06 } },
            { value: 'FENTANYL_50', label: 'Fentanyl 50 mikg/ml', formula: { dog: 0.02, cat: null } }, // Range 0.02-0.04 for dog
            { value: 'HEMOSILATE_125', label: 'Hemosilate 125 mg/ml', formula: { dog: 0.1, cat: 0.1 } },
            { value: 'RIVALGIN_500', label: 'Rivalgin 500 mg/ml', formula: { dog: 0.1, cat: null } },
            { value: 'DIAZEDOR_5', label: 'Diazedor 5 mg/ml', formula: { dog: 0.05, cat: null } },
            { value: 'MIDAZOLAM_1', label: 'Midazolam 1 mg/ml', formula: { dog: 0.25, cat: null } }
        ];
        return options;
    } catch (error) {
